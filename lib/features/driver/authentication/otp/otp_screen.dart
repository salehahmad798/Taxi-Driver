      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            /// Info text - No Obx needed
            CText(
              text: 'A code has been sent to ${_otpController.phone.replaceFirst('+', '')}',
              fontSize: 14.sp,
            ...
            Obx(() => _otpController.generalError.value != null
                ? Container(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.error, color: AppColors.kprimaryColor, size: 20.sp),
                        SizedBox(width: 10.w),
                        Expanded(
                          child: Text(
